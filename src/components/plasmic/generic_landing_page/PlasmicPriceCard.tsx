...
import sty from "./PlasmicPriceCard.module.css"; // plasmic-import: QNL51K7KMJjCYM/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__e0Out)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__yBqca)}>
          <div className={classNames(projectcss.all, sty.freeBox__fz6Jq)}>
            {p.renderPlasmicSlot({
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__egB98)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__dpyjf)}>
            <div
              className={classNames(
                projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox___2FVJ)}>
              {p.renderPlasmicSlot({
                defaultContents: "8",
                value: args.dollars,
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___9Oej)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__hdy7E)}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <React.Fragment>
                <ValueProp
                  className={classNames("__wab_instance", sty.valueProp__pxj7)}
                  description={
                    "Vestibulum mollis odio dictum ultrices facilisis molestie vestibulum"
                  }
                  icon={
                    <CheckIcon
                      className={classNames(projectcss.all, sty.svg__xPhH)}
                      role={"img"}
                    />
                  }
                />
                ...
                <ValueProp
                  className={classNames(
                    "__wab_instance",
                    sty.valueProp___8Gpyp
                  )}
                  description={"Mus consequat a justo"}
                  icon={
                    <CheckIcon
                      className={classNames(projectcss.all, sty.svg__hFp6M)}
                      role={"img"}
                    />
                  }
                />
