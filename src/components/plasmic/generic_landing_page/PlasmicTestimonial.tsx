...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: qLFLgUJFkm26DU/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__a83Xn)}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__mrMyy)}
      >
        <p.PlasmicImg
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__kBwkw)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__irrmi)}>
            {p.renderPlasmicSlot({
